...
- Support for `npx skills add` installation
- Claude Code plugin marketplace integration
- Manual installation support
- Multi-agent compatibility (Claude Code, Cursor, Codex, OpenCode, Windsurf, 20+ more)
